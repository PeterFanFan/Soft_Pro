...
def feature_extraction(tmpfile,min_len,encoding_type="One_hot"):
    ...
    forward_feature.to_csv(method_path+filename+"forward_"+str(min_len)+"_"+encoding_type+".csv")
    backward_feature.to_csv(method_path+filename+"backward_"+str(min_len)+"_"+encoding_type+".csv")
